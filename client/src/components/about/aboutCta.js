  ...
  return (
    <section className="relative py-20 md:py-28 bg-gradient-to-br from-zinc-950 via-slate-900 to-zinc-950 overflow-hidden">
      ...
      >
        ...
        >
          Ready to Discuss Your Next Important Decision?
        </motion.h2>

        <motion.p
          variants={fadeUp}
          transition={{ duration: 0.6, ease: 'easeOut' }}
          className="text-sm sm:text-base md:text-lg text-zinc-300 leading-relaxed mb-10"
        >
          Whether you need legal guidance, business advice, financial insight, or strategic support,
          Casa Di Consiglio is ready to help.
        </motion.p>
