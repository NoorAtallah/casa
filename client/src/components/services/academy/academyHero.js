...
import { GraduationCap, ArrowRight, ChevronRight, Languages, Globe2 } from 'lucide-react';
  ...
  return (
    <section className="relative overflow-hidden bg-zinc-950">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-0 left-1/4 w-96 h-96 rounded-full bg-[#6B5B47]/20 blur-3xl" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pt-16 pb-20 md:pt-20 md:pb-24">
        ...
        >
          ...
          <ChevronRight className="w-3 h-3" />
          <span className="text-[#BDA985] font-semibold">Casa Academy</span>
        </motion.nav>
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          >
            <div className="relative h-[340px] sm:h-[420px] lg:h-[540px] rounded-3xl overflow-hidden shadow-2xl border border-zinc-800">
              <img
                src="https://images.unsplash.com/photo-1524178232363-1fb2b075b655?w=1200&h=1400&fit=crop&auto=format"
                alt="Spanish language programmes in Dubai"
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(160deg, rgba(0,0,0,0.3) 0%, rgba(9,9,11,0.5) 55%, rgba(189,169,133,0.35) 100%)',
                }}
              />
            </div>
            ...
            <motion.div
              ...
              className="hidden md:block absolute -bottom-8 -right-8 p-6 rounded-2xl bg-gradient-to-br from-zinc-900 to-zinc-950 border border-[#BDA985]/30 shadow-2xl max-w-[16rem]"
            >
              <Globe2 className="w-7 h-7 text-[#BDA985] mb-3" />
              <p className="text-white font-bold leading-snug">
                A bridge between people,{' '}
                <span className="text-[#BDA985]">cultures, and opportunities.</span>
              </p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              Spanish Language Programmes Designed for{' '}
            ...
            >
              Language is more than a skill — it is a bridge between people, cultures, and
              opportunities.
            </motion.p>
        ...
        >
          <div className="flex items-start gap-4">
            <div className="w-11 h-11 shrink-0 rounded-xl bg-[#BDA985]/15 flex items-center justify-center">
              <Languages className="w-5 h-5 text-[#BDA985]" />
            </div>
            <div>
              ...
              <p className="text-sm md:text-base text-zinc-400 leading-relaxed">
                Our programmes focus on real-world application, helping learners build confidence in
                speaking, understanding, and engaging in Spanish-speaking environments.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            <div className="w-11 h-11 shrink-0 rounded-xl bg-[#BDA985]/15 flex items-center justify-center">
              <GraduationCap className="w-5 h-5 text-[#BDA985]" />
            </div>
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#BDA985] mb-3">
                Whatever your goal
              ...
              <p className="text-sm md:text-base text-zinc-400 leading-relaxed">
                Whether you are learning Spanish for personal development, professional growth,
                travel, or international business relationships, Casa Academy provides a practical and
